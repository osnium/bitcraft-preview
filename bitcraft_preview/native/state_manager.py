...
class NativeModeStateManager:
    ...
    def upsert_instance(
        ...
        *,
        ...
        overlay_nickname: str | None = None,
        local_user_sid: str | None = None,
        ...
        instance = NativeInstance(
            ...
            local_user_sid=existing.get("local_user_sid", "") if local_user_sid is None else local_user_sid,
            managed_by_app=True,
            managed_created_at=existing.get("managed_created_at", _utc_now_iso()),
            password_encrypted=password_encrypted,
            password_decryption_key="DPAPI",
            steam_account_name=existing.get("steam_account_name", "") if steam_account_name is None else steam_account_name,
            entity_id=existing.get("entity_id", "") if entity_id is None else entity_id,
            overlay_nickname=existing.get("overlay_nickname", "") if overlay_nickname is None else overlay_nickname,
            instance_root=existing.get("instance_root", "") if instance_root is None else instance_root,
