...
class SettingsPanel(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.lock_overlay_tiles = QCheckBox("Lock overlay tiles")
        self.lock_overlay_tiles.stateChanged.connect(
            lambda: self._set_user_bool("lock_overlay_tiles", self.lock_overlay_tiles.isChecked())
        )
        overlay_layout.addWidget(self.lock_overlay_tiles, 5, 0, 1, 3)
        ...
        overlay_layout.addWidget(self.hover_zoom_enabled, 6, 0, 1, 3)
        ...
        self._add_inline_slider_row(overlay_layout, 7, self.hover_zoom_name, self.hover_zoom_percent, self.hover_zoom_value)
        ...
        self._add_inline_slider_row(overlay_layout, 8, self.preview_tile_width_name, self.preview_tile_width, self.preview_tile_width_value)
        ...
        self._add_inline_slider_row(overlay_layout, 9, self.preview_tile_height_name, self.preview_tile_height, self.preview_tile_height_value)

        self.tile_preview = TilePreviewWidget(self)
        overlay_layout.addWidget(self.tile_preview, 10, 0, 1, 3)
    ...
    def _load_values(self) -> None:
        ...
        self.lock_overlay_tiles.setChecked(bool(user.get("lock_overlay_tiles", False)))
